...
declare const _default: import('vue').DefineComponent<import('vue').ExtractPropTypes<{
    ...
    [key: string]: any;
}>[] | undefined)[], {}, {}, {}, import('vue').ComponentOptionsMixin, import('vue').ComponentOptionsMixin, ("map:error" | "map:load" | "map:idle" | "map:remove" | "map:render" | "map:resize" | "map:webglcontextlost" | "map:webglcontextrestored" | "map:dataloading" | "map:data" | "map:sourcedataloading" | "map:styledataloading" | "map:sourcedata" | "map:styledata" | "map:style.load" | "map:styleimagemissing" | "map:dataabort" | "map:sourcedataabort" | "map:boxzoomcancel" | "map:boxzoomstart" | "map:boxzoomend" | "map:touchcancel" | "map:touchmove" | "map:touchend" | "map:touchstart" | "map:click" | "map:contextmenu" | "map:dblclick" | "map:mousemove" | "map:mouseup" | "map:mousedown" | "map:mouseout" | "map:mouseover" | "map:movestart" | "map:move" | "map:moveend" | "map:zoomstart" | "map:zoom" | "map:zoomend" | "map:rotatestart" | "map:rotate" | "map:rotateend" | "map:dragstart" | "map:drag" | "map:dragend" | "map:pitchstart" | "map:pitch" | "map:pitchend" | "map:rollstart" | "map:roll" | "map:rollend" | "map:wheel" | "map:terrain" | "map:cooperativegestureprevented" | "map:projectiontransition" | "update:center" | "update:zoom" | "update:pitch" | "update:bearing")[], "map:error" | "map:load" | "map:idle" | "map:remove" | "map:render" | "map:resize" | "map:webglcontextlost" | "map:webglcontextrestored" | "map:dataloading" | "map:data" | "map:sourcedataloading" | "map:styledataloading" | "map:sourcedata" | "map:styledata" | "map:style.load" | "map:styleimagemissing" | "map:dataabort" | "map:sourcedataabort" | "map:boxzoomcancel" | "map:boxzoomstart" | "map:boxzoomend" | "map:touchcancel" | "map:touchmove" | "map:touchend" | "map:touchstart" | "map:click" | "map:contextmenu" | "map:dblclick" | "map:mousemove" | "map:mouseup" | "map:mousedown" | "map:mouseout" | "map:mouseover" | "map:movestart" | "map:move" | "map:moveend" | "map:zoomstart" | "map:zoom" | "map:zoomend" | "map:rotatestart" | "map:rotate" | "map:rotateend" | "map:dragstart" | "map:drag" | "map:dragend" | "map:pitchstart" | "map:pitch" | "map:pitchend" | "map:rollstart" | "map:roll" | "map:rollend" | "map:wheel" | "map:terrain" | "map:cooperativegestureprevented" | "map:projectiontransition" | "update:center" | "update:zoom" | "update:pitch" | "update:bearing", import('vue').PublicProps, Readonly<import('vue').ExtractPropTypes<{
    /**
     * Width of the map container
     */
    width: {
    ...
    "onMap:style.load"?: ((...args: any[]) => any) | undefined;
    ...
    "onMap:rollstart"?: ((...args: any[]) => any) | undefined;
    "onMap:roll"?: ((...args: any[]) => any) | undefined;
    "onMap:rollend"?: ((...args: any[]) => any) | undefined;
